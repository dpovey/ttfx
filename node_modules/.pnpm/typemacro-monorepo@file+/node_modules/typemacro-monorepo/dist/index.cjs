...
__export(src_exports, {
  ...
  OrdDerive: () => OrdDerive,
  builtinDerivations: () => builtinDerivations,
  compose: () => compose,
  composeMacro: () => composeMacro,
  comptime: () => comptime,
  comptimeMacro: () => comptimeMacro,
  createMacroContext: () => createMacroContext,
  createRegistry: () => createRegistry,
  createTypeclassDeriveMacro: () => createTypeclassDeriveMacro,
  ...
  generateStandardTypeclasses: () => generateStandardTypeclasses,
  getOperatorMethod: () => getOperatorMethod,
  ...
  operators: () => operators,
  operatorsAttribute: () => operatorsAttribute,
  ops: () => ops,
  opsMacro: () => opsMacro,
  pipe: () => pipe,
  pipeMacro: () => pipeMacro,
...
function findInstance(tcName, typeName) {
...
function generateStandardTypeclasses() {
  return `
// ============================================================================
...
// src/index.ts
function comptime(fn) {
  return fn();
}
function derive(..._derives) {
  return () => {
  };
}
function operators(_mappings) {
  return () => {
  };
}
function ops(expr) {
...
function typeclass(target, _context) {
  return target;
}
function instance(_typeName) {
  return () => {
  };
}
function deriving(..._typeclasses) {
  return () => {
  };
}
function summon() {
