...
var MacroTransformer = class {
  ...
  tryExpandAttributeMacros(node) {
    ...
    for (const decorator of decorators) {
      ...
      if (macroName === "derive") {
        const deriveMacroResolved = identNode ? this.resolveMacroFromSymbol(identNode, "derive", "attribute") : globalRegistry.getAttribute("derive");
      ...
      const macro = identNode ? this.resolveMacroFromSymbol(identNode, macroName, "attribute") : globalRegistry.getAttribute(macroName);
      if (macro) {
        if (this.verbose) {
