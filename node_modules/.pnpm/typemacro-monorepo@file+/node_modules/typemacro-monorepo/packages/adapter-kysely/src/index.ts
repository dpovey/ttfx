 ...
 *
 * ```ts
 * import { sql } from "@typemacro/adapter-kysely";
 ...
 *
 * ```ts
 * import { ksql } from "@typemacro/adapter-kysely";
 *
...
export function ksql<T = unknown>(
  ...
  throw new Error(
    "ksql was not transformed at compile time. " +
      "Make sure @typemacro/adapter-kysely is registered with the transformer.",
  );
}
