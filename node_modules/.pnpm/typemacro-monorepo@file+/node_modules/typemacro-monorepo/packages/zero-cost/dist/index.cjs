...
__export(index_exports, {
  ...
  Result: () => Result,
  debugOnly: () => debugOnly,
  debugOnlyMacro: () => debugOnlyMacro,
  flow: () => flow,
  flowMacro: () => flowMacro,
  invariant: () => invariant,
  invariantMacro: () => invariantMacro,
  match: () => match,
  matchGuard: () => matchGuard,
  matchGuardMacro: () => matchGuardMacro,
  matchLiteral: () => matchLiteral,
  matchLiteralMacro: () => matchLiteralMacro,
  matchMacro: () => matchMacro,
  newtypeCtor: () => newtypeCtor,
  newtypeCtorMacro: () => newtypeCtorMacro,
  optionMacro: () => optionMacro,
  pipe: () => pipe,
  pipeMacro: () => pipeMacro,
  ...
  staticAssertMacro: () => staticAssertMacro,
  typeAssert: () => typeAssert,
  typeAssertMacro: () => typeAssertMacro,
  unreachable: () => unreachable,
  unreachableMacro: () => unreachableMacro,
  unwrap: () => unwrap,
  unwrapMacro: () => unwrapMacro,
  validatedNewtype: () => validatedNewtype,
  wrap: () => wrap,
  wrapMacro: () => wrapMacro
});
...
var optionMacro = (0, import_core.defineExpressionMacro)({
  name: "Option",
...
import_core.globalRegistry.register(optionMacro);

// src/result.ts
var ts2 = __toESM(require("typescript"), 1);
var import_core2 = require("@typemacro/core");
var Result = {
...
var resultMacro = (0, import_core2.defineExpressionMacro)({
  name: "Result",
...
import_core2.globalRegistry.register(resultMacro);

// src/newtype.ts
var ts3 = __toESM(require("typescript"), 1);
var import_core3 = require("@typemacro/core");
function wrap(value) {
  return value;
}
...
var wrapMacro = (0, import_core3.defineExpressionMacro)({
  name: "wrap",
...
var unwrapMacro = (0, import_core3.defineExpressionMacro)({
  name: "unwrap",
...
var newtypeCtorMacro = (0, import_core3.defineExpressionMacro)({
  name: "newtypeCtor",
...
import_core3.globalRegistry.register(wrapMacro);
import_core3.globalRegistry.register(unwrapMacro);

// src/pipe.ts
var ts4 = __toESM(require("typescript"), 1);
var import_core4 = require("@typemacro/core");
...
var pipeMacro = (0, import_core4.defineExpressionMacro)({
  name: "pipe",
...
var flowMacro = (0, import_core4.defineExpressionMacro)({
  name: "flow",
...
import_core4.globalRegistry.register(pipeMacro);
import_core4.globalRegistry.register(flowMacro);

// src/assert.ts
var ts5 = __toESM(require("typescript"), 1);
var import_core5 = require("@typemacro/core");
...
var staticAssertMacro = (0, import_core5.defineExpressionMacro)({
  name: "staticAssert",
...
var typeAssertMacro = (0, import_core5.defineExpressionMacro)({
  name: "typeAssert",
...
var invariantMacro = (0, import_core5.defineExpressionMacro)({
  name: "invariant",
...
var unreachableMacro = (0, import_core5.defineExpressionMacro)({
  name: "unreachable",
...
var debugOnlyMacro = (0, import_core5.defineExpressionMacro)({
  name: "debugOnly",
...
var sizeofMacro = (0, import_core5.defineExpressionMacro)({
  name: "sizeof",
...
import_core5.globalRegistry.register(staticAssertMacro);
import_core5.globalRegistry.register(typeAssertMacro);
import_core5.globalRegistry.register(invariantMacro);
import_core5.globalRegistry.register(unreachableMacro);
import_core5.globalRegistry.register(debugOnlyMacro);
import_core5.globalRegistry.register(sizeofMacro);

// src/match.ts
var ts6 = __toESM(require("typescript"), 1);
var import_core6 = require("@typemacro/core");
...
var matchMacro = (0, import_core6.defineExpressionMacro)({
  name: "match",
...
var matchLiteralMacro = (0, import_core6.defineExpressionMacro)({
  name: "matchLiteral",
...
var matchGuardMacro = (0, import_core6.defineExpressionMacro)({
  name: "matchGuard",
...
import_core6.globalRegistry.register(matchMacro);
import_core6.globalRegistry.register(matchLiteralMacro);
import_core6.globalRegistry.register(matchGuardMacro);
