...
__export(index_exports, {
  clearOperatorMappings: () => clearOperatorMappings,
...
var operatorsAttribute = (0, import_core.defineAttributeMacro)({
  name: "operators",
...
var opsMacro = (0, import_core.defineExpressionMacro)({
  name: "ops",
  module: "@typemacro/operators",
...
var composeMacro = (0, import_core.defineExpressionMacro)({
  name: "compose",
  module: "@typemacro/operators",
...
function register() {
  import_core.globalRegistry.register(operatorsAttribute);
  import_core.globalRegistry.register(opsMacro);
  import_core.globalRegistry.register(pipeMacro);
  import_core.globalRegistry.register(composeMacro);
}
register();
