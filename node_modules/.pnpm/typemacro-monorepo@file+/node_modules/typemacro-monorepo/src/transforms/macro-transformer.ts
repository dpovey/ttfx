...
class MacroTransformer {
  ...
  private recordMacroImport(originalSymbol: ts.Symbol): void {
    ...
    for (const decl of declarations) {
      ...
      // Namespace import: import * as M from "typemacro"
      ...
      // Default import: import comptime from "typemacro"
   ...
   *   - Direct imports:  import { comptime } from "typemacro"
   *   - Renamed imports: import { comptime as ct } from "typemacro"
   *   - Barrel re-exports: import { comptime } from "./utils"
   *                        (where ./utils re-exports from "typemacro")
   *   - Namespace imports: import * as M from "typemacro"; M.comptime()
   *
