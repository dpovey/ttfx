 ...
 */
export function eventListenerResource<K extends keyof HTMLElementEventMap>(
...
export class ResourcePool<A> {
   ...
   */
  drain(): IO<void> {
    return IO.traverse(this.pool, (a) => this.destroy(a)).void_();
  }
}
